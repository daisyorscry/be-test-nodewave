...
import { uploadSingleFileMiddleware } from "$middlewares/uploadMiddleware";
...
FileRoutes.post("/", requireRole(ROLES.ADMIN), uploadSingleFileMiddleware, validateCreateFile, FileController.create);
